[navdeepproject-11f8] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [navdeepproject-11f8] container is NOT running**.

.. tip::
   You must have your [navdeepproject-11f8] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/navdeeptura/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=35983  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='navdeeptura'  \-\-env DOCKERUSERNAME='navdeeptura'  \-\-env MQTTUSERNAME='turanavdeep'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   navdeeptura/navdeepproject-11f8-amd64 (https://hub.docker.com/r/navdeeptura/navdeepproject-11f8-amd64)
...
.. important::
   docker run -d -p 52757:52757 -p 58075:58075 -p 33609:33609 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=navdeepproject-11f8 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-navdeepproject-11f8 \-\-env GITUSERNAME=navdeeptura  \-\-env GITREPOURL=https://github.com/navdeeptura/raspberrypi \-\-env SOLUTIONEXTERNALPORT=52757  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=58075  \-\-env SOLUTIONVIPERVIZPORT=33609 \-\-env DOCKERUSERNAME='navdeeptura' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=35983 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='turanavdeep' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  navdeeptura/navdeepproject-11f8-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=33609
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=52757
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - navdeeptura/navdeepproject-11f8-amd64
...
It can be accessed by entering: http://localhost:58075
...
.. important::
   http://localhost:33609/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:33609/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:33609/<html file>
...
[navdeepproject-11f8] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/navdeeptura/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/navdeepproject-11f8
...
.. important::
   https://navdeepproject-11f8.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-navdeepproject-11f8
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=52757, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=44961, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=43161, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=35913, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=42961, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=36059, HPDEHOST=127.0.1.1, HPDEPORT=36311, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=42163

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6485-navdeepproject-11f8,solution_preprocessing_ai_mqtt_dag-navdeepproject-11f8, python-preprocess-117-navdeepproject-11f8,solution_preprocessing_ai_mqtt_dag-navdeepproject-11f8, python-ai-3584-navdeepproject-11f8,solution_preprocessing_ai_mqtt_dag-navdeepproject-11f8, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
